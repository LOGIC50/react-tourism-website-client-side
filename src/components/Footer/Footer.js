      ...
      <div className="footer-container text-light">
        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-4">
          <div className="col text-center">
            <h3>
              Tour <span className="text-danger">Takers</span>
            </h3>
            <p>
              Tourism Tiger designs travel & tourism websites that are effective
              from day one, and our ongoing updates ensure they stay effective
            </p>
            <p>
              {" "}
              As dedicated tourism specialists, our focus has allowed us to
              develop the best possible website features for tour and activity
              businesses
            </p>
          </div>
